...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smartparens skewer-mode impatient-mode apheleia nvm zenburn-theme yasnippet ws-butler which-key web-mode vue-mode visual-fill-column use-package ubuntu-theme tron-legacy-theme tide the-matrix-theme rainbow-mode rainbow-delimiters pyvenv python-mode professional-theme prettier-js powershell org-bullets nimbus-theme night-owl-theme lsp-ui lsp-pyright lsp-latex lsp-ivy lsp-dart json-mode js2-mode jedi ivy-rich iceberg-theme highlight-indentation helpful gotham-theme gnu-elpa forge flutter espresso-theme eshell-git-prompt emmet-mode eink-theme doom-themes doom-modeline dired-single dired-open dired-hide-dotfiles cyberpunk-theme cyberpunk-2019-theme csv-mode counsel-projectile conda company-go company-box company-anaconda command-log-mode borland-blue-theme auto-package-update all-the-icons-dired add-node-modules-path acme-theme)))
(custom-set-faces
